...
const SignupForm = () => {
  ...
  return (
    <div className="signupFormContainer">
      ...
      <input
        type={showPassword ? "password" : "text"} // If showPassword is true, hide text
        name="password"
        id="password"
      ...
      />
      {/* eye icon */}
      <i style={{cursor: 'pointer'}} onClick={() => setShowPassword(!showPassword)}>
        {showPassword ? ( // If showPassword is true, show eye with slash
          <svg
          width={26}
          height={26}
          viewBox="0 0 24 24"
